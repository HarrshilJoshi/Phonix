...
useEffect(() => {
  ...
  const apiBase = import.meta.env.DEV ? "http://localhost:3000" : "https://phonix-x7de.onrender.com";
...
trackPlayedSong(selectedSong);
    ...
    const SERVER_URL = import.meta.env.DEV ? "http://localhost:3000" : "https://phonix-x7de.onrender.com";
